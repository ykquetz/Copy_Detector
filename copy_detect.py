...
class SonucPenceresi(ctk.CTkToplevel):
    ...
    def sayfayi_ciz(self):
        ...
        for i, grup in enumerate(gosterilecekler):
            ...
            kilit_btn = ctk.CTkButton(
                ...
                font=("Arial", 11),
                command=lambda g=grup: self._kilit_durumunu_degistir(g),
            )
    ...
    def _kilit_durumunu_degistir(self, grup):
...
class KopyaBulucuUygulamasi(ctk.CTk):
    def __init__(self):
        ...
        self.yol_girisi = ctk.CTkEntry(self.ust_frame, width=450, placeholder_text="Dosya yolunu buraya yapıştırın...")
        self.yol_girisi.pack(pady=10)
